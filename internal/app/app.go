...
func (a App) BuildSpec() spec.Spec {
	...
	return spec.Spec{
		...
		Commands: []spec.CommandSpec{
			...
			{
				Name:        "serve",
				Description: "Start the local web management server",
				Flags: append(globalFlags,
					spec.FlagSpec{Name: "addr", Default: "127.0.0.1:8788", Env: "XSQL_WEB_HTTP_ADDR", Description: "Web HTTP listen address"},
			...
			{
				Name:        "web",
				Description: "Start the local web management server and open a browser",
				Flags: append(globalFlags,
					spec.FlagSpec{Name: "addr", Default: "127.0.0.1:8788", Env: "XSQL_WEB_HTTP_ADDR", Description: "Web HTTP listen address"},
					spec.FlagSpec{Name: "auth-token", Default: "", Env: "XSQL_WEB_HTTP_AUTH_TOKEN", Description: "Bearer auth token required for non-loopback addresses"},
					spec.FlagSpec{Name: "allow-plaintext", Default: "false", Description: "Allow plaintext secrets in config"},
